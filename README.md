...
docs/          api.md · architecture.md · deployment.md · multi-tenancy.md ·
               payments.md · integrations.md · coding_guidelines.md
docker-compose.yml
```
...
- **[docs/payments.md](docs/payments.md)** — mobile money: providers, webhooks,
  reconciliation, and how it is tested without live credentials
