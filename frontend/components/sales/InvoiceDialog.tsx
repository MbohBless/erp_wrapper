...
import type { SalesInvoiceInput } from "@/lib/sales";
...
export default function InvoiceDialog({
  ...
  busy: boolean;
  error: string | null;
  onSubmit: (input: SalesInvoiceInput) => void;
  onCancel: () => void;
}) {
  ...
  return (
    ...
    >
      <form
        ...
        onSubmit={submit}
      >
        <h3 className="font-heading font-semibold text-xl mb-4">New invoice</h3>
        {error && (
